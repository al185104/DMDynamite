namespace DMDynamite.Models
{
    public class PopupSizeConstants
    {
        public PopupSizeConstants(IDeviceDisplay deviceDisplay)
        {
            ...
            Full = new(1 * (deviceDisplay.MainDisplayInfo.Width / deviceDisplay.MainDisplayInfo.Density), 1 * (deviceDisplay.MainDisplayInfo.Height / deviceDisplay.MainDisplayInfo.Density));
        }
